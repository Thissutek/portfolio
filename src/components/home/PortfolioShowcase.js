...
const PortfolioShowcase = () => {
  ...
  const heroProject = {
    ...
    description:
      "Award-winning AI-powered talent matching web app that streamlines the interview process. Ranks candidates based on their interviews and resumes through AI video interviews, revolutionizing recruitment with intelligent matching algorithms.",
  ...
  const featuredProjects = {
    ...
    aiCourse: {
      ...
      description:
        "Assisting instructor for BraveCareer's Fullstack AI Engineer course. Created educational tip videos covering freelancing strategies and navigation advice for aspiring AI software developers entering the freelance market.",
    ...
    savyr: {
      ...
      title: "Savyr",
      description:
        "AI-powered meal planner that parses images from flyers to create affordable meal plans. Available on iOS and Google Play Store.",
      thumbnail: "/imgs/appstore.png",
      link: "https://apps.apple.com/ca/app/savyr/id6748922640",
      tags: ["React Native", "Expo", "Supabase", "AI"],
      disclaimer:
        "Client project completed under NDA. All intellectual property rights belong to the client.",
    },
    chromeExt: {
      id: "chrome-ext",
      category: "client",
      ...
      description:
        "AI-powered note-taking Chrome extension featuring Deepgram AI for speech-to-text and text-to-speech capabilities.",
  ...
  const bottomProjects = [
    {
      ...
      title: "Aims2Learn",
      description:
        "Business website development including brand finalization, business model consultation, and customer attraction strategy. Complete business launch support beyond just coding.",
    ...
    },
    {
      ...
      link: "https://github.com/Thissutek/discord-bot",
    ...
    },
    {
      ...
      description:
        "Full-stack shopping platform with modern UX, dance-inspired animations, and complete database integration",
      thumbnail: "/imgs/e-commerce.png",
      link: "https://github.com/Thissutek/my-ecommerce-app",
  ...
  const danceProjects = [
    ...
    },
    {
      ...
      title: "Feel No Ways",
      description:
        "Neo renaissance theme concept video with production lighting directors - full day shoot",
    ...
    },
    {
      ...
      description:
        "Dance competition performance showcasing technical skill and artistry",
          ...
          <div className="flex h-full">
            <div className="relative w-1/2 overflow-hidden">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: isDanceMode
                        ? `0 0 20px ${currentColors.glow}44`
                        : "none",
                    }}
                  >
              ...
              <div
                ...
                style={{
                  backgroundColor: isDanceMode
                    ? `${currentColors.accent}88`
                    : `${colors.peach}88`,
            ...
            <div className="flex-1 p-4 flex flex-col justify-between">
              <div>
                <h4
                  ...
                  style={{
                    color: isDanceMode ? currentColors.text : colors.text,
                  }}
                >
                  {item.title}
                </h4>
              ...
              {item.disclaimer && (
                <div className="mt-2">
                  <p
                    ...
                    style={{
                      color: isDanceMode ? currentColors.text : colors.subtext,
                    }}
                  >
                    {item.disclaimer}
                  </p>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            >
              {isDanceMode
                ? "Inspired by my artistry?"
                : "Ready to bring creativity to your team?"}
            </h3>
            <p
